...
Functionalities will be available using a command-driven UI:
...
2. Display all rectangle data, sorted descending by the length of its longest side
...
3. Delete all rectangles that are contained within a given rectangle
